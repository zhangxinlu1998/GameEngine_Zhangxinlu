    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                o.color = v.color;
                float dirsignX = step(0,dir.x);
                float dirsignZ = step(0,dir.z);
                o.localPos.x += clamp(dir * (easeInOutCubic(o.localPos.x* _Power*2*((1-v.color.b) *dirsignX + v.color.b *(1-dirsignX)))),-1,1);
                //o.localPos.y -= clamp(dir * (easeInOutCubic(v.color.g * _Power*5)),0,1);
                //o.localPos.z *= easeInOutCubic(saturate(length(0.6-dir))) * _Power;
